...
#if 1
idCVar idImageManager::image_downSize( "image_downSize", "1", CVAR_RENDERER | CVAR_ROM, "controls texture downsampling" );
idCVar idImageManager::image_forceDownSize( "image_forceDownSize", "1", CVAR_RENDERER | CVAR_ROM | CVAR_BOOL, "" );
...
idCVar idImageManager::image_downSizeBump( "image_downSizeBump", "1", CVAR_RENDERER | CVAR_ROM, "controls normal map downsampling" );
